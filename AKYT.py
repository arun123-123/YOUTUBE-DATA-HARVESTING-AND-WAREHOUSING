...
client=pymongo.MongoClient("mongodb+srv://ArunAK:ARUNAKDS@cluster0.bpcx6.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")

db=client["AK_data"]

def Akch_details(channel_id):
...
def channels_table(channel_name_s):
    ...
    if channel_name_s in chann_list2:
        ...
        for ch_data in coll1.find({"channel_information.Channel_Name":channel_name_s},{"_id":0}):
            single_Akch_details.append(ch_data["channel_information"])

        df_single_channel= pd.DataFrame(single_Akch_details)
...
def playlist_table(channel_name_s):
    ...
    coll1=db["Akch_details"]
    for ch_data in coll1.find({"channel_information.Channel_Name":channel_name_s},{"_id":0}):
        single_Akch_details.append(ch_data["playlist_information"])

    df_single_channel= pd.DataFrame(single_Akch_details[0])
...
def videos_table(channel_name_s):
    ...
    coll1=db["Akch_details"]
    for ch_data in coll1.find({"channel_information.Channel_Name":channel_name_s},{"_id":0}):
        single_Akch_details.append(ch_data["video_information"])
...
def comments_table(channel_name_s):
    ...
    coll1=db["Akch_details"]
    for ch_data in coll1.find({"channel_information.Channel_Name":channel_name_s},{"_id":0}):
        single_Akch_details.append(ch_data["comment_information"])
...
if st.button("collect and store data"):
    ...
    if channel_id in ch_ids:
        ...
        insert=Akch_details(channel_id)
        st.success(insert)
